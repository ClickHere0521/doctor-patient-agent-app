    ...
    <Block flex style={styles.container}>
          ...
          <Block row style={styles.head}>
            ...
            <Block>
              <Text
                color="white"
                size={20}
                style={{ fontFamily: "Inter-Black", paddingLeft: 20 }}
                bold
              >
                Select a time slot
              </Text>
      ...
      >
        <ScrollView>
          <Block
            row
            style={{ margin: 10, borderBottomWidth: 1, borderColor: "#F0F0F0" }}
          >
            <Image
            ...
            <Block center>
              ...
              <Text color={"grey"}>B.Sc, MBBS, DDVL, MD- Dermitol...</Text>
            </Block>
          </Block>
          <Block row center style={{ margin: 10 }}>
            <Icon
              size={20}
              name="arrow-circle-left"
              family="font-awesome"
              style={{ padding: 5, marginRight: width * 0.1 }}
              color="grey"
            />
            ...
            <Icon
              ...
              family="font-awesome"
              style={{ padding: 5, marginLeft: width * 0.1 }}
              color="grey"
            />
          </Block>
          <Block
          ...
          >
            <Text style={{ paddingHorizontal: width * 0.03 }}>10.00</Text>
            <Text style={{ paddingHorizontal: width * 0.03 }}>11.00</Text>
            <Text style={{ paddingHorizontal: width * 0.03 }}>12.00</Text>
            <Text style={{ paddingHorizontal: width * 0.03 }}>12.00</Text>
            <Text style={{ paddingHorizontal: width * 0.03 }}>12.00</Text>
            <ImageBackground
          ...
          >
            ...
            >
              <Block style={{ top: 0, left: 24, position: "absolute" }}>
                <Text size={12}>Evening and Night</Text>
              </Block>
            </ImageBackground>
          </Block>
          <TouchableOpacity
